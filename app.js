...
app.route("/addnote")
  ...
  .post(function(req, res) {
    ...
    noteToAdd.save(function(err, addedNote){
      ...
      res.send('<h1>Notatka zapisana poprawnie:</h1>' +
                '<p>Title: ' + addedNote.title + '</p>' +
                '<p>Keywords: ' + addedNote.keywords +'</p>' +
                '<p>Notes: ' +  addedNote.notes + '</p>' +
                '<p>Summary:' +  addedNote.summary +' </p>');
    });
  });
